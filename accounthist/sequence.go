...
type sequenceData struct {
	nextOrdinal        uint64 // while in memory, this value is the NEXT history seq num that should be attributed, in this shard.
...
func (sqd *sequenceData) MarshalLogObject(encoder zapcore.ObjectEncoder) error {
	encoder.AddUint64("history_seq_num", sqd.nextOrdinal)
