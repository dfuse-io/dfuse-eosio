...
func Test_AccountContractLiveShard(t *testing.T) {
	...
	assert.Equal(t, []*actionResult{
		{cursor: "04c524a0800000000039b398a96e54539000fffffffffffffffe:00:1", actionTrace: ct.ActionTrace(t, "some1:battlefieldt:init", ct.GlobalSequence(2))},
