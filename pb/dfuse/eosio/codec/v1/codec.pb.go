...
type FilteringKind int32

const (
	// The Block is fully unfiltered, i.e. it contains everything initial read
	FilteringKind_FILTERINGKIND_UNFILTERED FilteringKind = 0
	// The Block has been filtered by some process, the field `filtering_metadata` will be present
	// with further information.
	FilteringKind_FILTERINGKIND_FILTERED FilteringKind = 1
)

var FilteringKind_name = map[int32]string{
	0: "FILTERINGKIND_UNFILTERED",
	1: "FILTERINGKIND_FILTERED",
}

var FilteringKind_value = map[string]int32{
	"FILTERINGKIND_UNFILTERED": 0,
	"FILTERINGKIND_FILTERED":   1,
}

func (x FilteringKind) String() string {
	return proto.EnumName(FilteringKind_name, int32(x))
}

func (FilteringKind) EnumDescriptor() ([]byte, []int) {
...
func (RAMOp_Namespace) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_3286b8d338e80dff, []int{34, 1}
}
...
func (RAMOp_Action) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_3286b8d338e80dff, []int{34, 2}
}
...
func (FeatureOp_Kind) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_3286b8d338e80dff, []int{39, 0}
}
...
func (PermOp_Operation) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_3286b8d338e80dff, []int{41, 0}
}
...
func (RlimitOp_Operation) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_3286b8d338e80dff, []int{49, 0}
}
...
type Block struct {
	...
	// Represents the filtering kind that was applied on this block
	FilteringKind FilteringKind `protobuf:"varint,40,opt,name=filtering_kind,json=filteringKind,proto3,enum=dfuse.eosio.codec.v1.FilteringKind" json:"filtering_kind,omitempty"`
	// Represents filtering metadata related to this block filtering when
	// this block has been filtered by a filtering process.
	FilteringMetadata    *FilteringMetadata `protobuf:"bytes,41,opt,name=filtering_metadata,json=filteringMetadata,proto3" json:"filtering_metadata,omitempty"`
...
func (m *Block) GetFilteringKind() FilteringKind {
	if m != nil {
		return m.FilteringKind
	}
	return FilteringKind_FILTERINGKIND_UNFILTERED
}

func (m *Block) GetFilteringMetadata() *FilteringMetadata {
	if m != nil {
		return m.FilteringMetadata
	}
	return nil
}

type FilteringMetadata struct {
	// The CEL filter in that was used to filter in transaction from this block
	CelFilterIn string `protobuf:"bytes,1,opt,name=cel_filter_in,json=celFilterIn,proto3" json:"cel_filter_in,omitempty"`
	// The CEL filter out that was used to filter out transaction from this block
	CelFilterOut         string   `protobuf:"bytes,2,opt,name=cel_filter_out,json=celFilterOut,proto3" json:"cel_filter_out,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *FilteringMetadata) Reset()         { *m = FilteringMetadata{} }
func (m *FilteringMetadata) String() string { return proto.CompactTextString(m) }
func (*FilteringMetadata) ProtoMessage()    {}
func (*FilteringMetadata) Descriptor() ([]byte, []int) {
	return fileDescriptor_3286b8d338e80dff, []int{1}
}

func (m *FilteringMetadata) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_FilteringMetadata.Unmarshal(m, b)
}
func (m *FilteringMetadata) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_FilteringMetadata.Marshal(b, m, deterministic)
}
func (m *FilteringMetadata) XXX_Merge(src proto.Message) {
	xxx_messageInfo_FilteringMetadata.Merge(m, src)
}
func (m *FilteringMetadata) XXX_Size() int {
	return xxx_messageInfo_FilteringMetadata.Size(m)
}
func (m *FilteringMetadata) XXX_DiscardUnknown() {
	xxx_messageInfo_FilteringMetadata.DiscardUnknown(m)
}

var xxx_messageInfo_FilteringMetadata proto.InternalMessageInfo

func (m *FilteringMetadata) GetCelFilterIn() string {
	if m != nil {
		return m.CelFilterIn
	}
	return ""
}

func (m *FilteringMetadata) GetCelFilterOut() string {
	if m != nil {
		return m.CelFilterOut
	}
	return ""
}
...
func (*TransactionEvent_AddedInternally) Descriptor() ([]byte, []int) {
	return fileDescriptor_3286b8d338e80dff, []int{18, 0}
}
...
func (*TransactionEvent_Added) Descriptor() ([]byte, []int) {
	return fileDescriptor_3286b8d338e80dff, []int{18, 1}
}
...
func (*TransactionEvent_Executed) Descriptor() ([]byte, []int) {
	return fileDescriptor_3286b8d338e80dff, []int{18, 2}
}
...
func (*TransactionEvent_DtrxScheduled) Descriptor() ([]byte, []int) {
	return fileDescriptor_3286b8d338e80dff, []int{18, 3}
}
...
func (*TransactionEvent_DtrxCanceled) Descriptor() ([]byte, []int) {
	return fileDescriptor_3286b8d338e80dff, []int{18, 4}
}
...
type Transaction struct {
	...
	// The array of context free action indices that matched the CEL filter applied to this
	// transaction. This field will be populated only when the Block containing
	// this transaction has pass through a filtering pipeline.
	FilteringMatchingContextFreeActions []uint64 `protobuf:"varint,10,rep,packed,name=filtering_matching_context_free_actions,json=filteringMatchingContextFreeActions,proto3" json:"filtering_matching_context_free_actions,omitempty"`
	// The array of action indices that matched the CEL filter applied to this
	// transaction. This field will be populated only when the Block containing
	// this transaction has pass through a filtering pipeline.
	FilteringMatchingActions []uint64 `protobuf:"varint,11,rep,packed,name=filtering_matching_actions,json=filteringMatchingActions,proto3" json:"filtering_matching_actions,omitempty"`
	XXX_NoUnkeyedLiteral     struct{} `json:"-"`
	XXX_unrecognized         []byte   `json:"-"`
	XXX_sizecache            int32    `json:"-"`
}
...
func (m *Transaction) GetFilteringMatchingContextFreeActions() []uint64 {
	if m != nil {
		return m.FilteringMatchingContextFreeActions
	}
	return nil
}

func (m *Transaction) GetFilteringMatchingActions() []uint64 {
	if m != nil {
		return m.FilteringMatchingActions
	}
	return nil
}
...
type TransactionTrace struct {
	...
	// The array of action trace indices that matched the CEL filter applied to this
	// transaction trace. This field will be populated only when the Block containing
	// this transaction trace has pass through a filtering pipeline.
	FilteringMatchingActionTraces []uint64 `protobuf:"varint,40,rep,packed,name=filtering_matching_action_traces,json=filteringMatchingActionTraces,proto3" json:"filtering_matching_action_traces,omitempty"`
	XXX_NoUnkeyedLiteral          struct{} `json:"-"`
	XXX_unrecognized              []byte   `json:"-"`
	XXX_sizecache                 int32    `json:"-"`
}
...
func (m *TransactionTrace) GetFilteringMatchingActionTraces() []uint64 {
	if m != nil {
		return m.FilteringMatchingActionTraces
	}
	return nil
}
...
func (*Exception_LogMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_3286b8d338e80dff, []int{57, 0}
}
...
func (*Exception_LogContext) Descriptor() ([]byte, []int) {
	return fileDescriptor_3286b8d338e80dff, []int{57, 1}
}
...
func init() {
	proto.RegisterEnum("dfuse.eosio.codec.v1.FilteringKind", FilteringKind_name, FilteringKind_value)
	...
	proto.RegisterType((*FilteringMetadata)(nil), "dfuse.eosio.codec.v1.FilteringMetadata")
...
var fileDescriptor_3286b8d338e80dff = []byte{
	// 6087 bytes of a gzipped FileDescriptorProto
	,
}
