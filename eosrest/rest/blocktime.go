...
func BlockTimeHandler(blockmetaClient *pbblockmeta.Client) http.Handler {
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		if err != nil {
			eosrest.WriteError(w, r, derr.RequestValidationError(ctx, url.Values{"time": []string{"timeshould be in a recognizable time format (ex: 2012-11-01T22:08:41+00:00)"}}))
			//////////////////////////////////////////////////////////////////////
		...
		default:
			eosrest.WriteError(w, r, derr.RequestValidationError(ctx, url.Values{"comparator": []string{"should be one of 'gt', 'gte', 'lt', 'lte' or 'eq'"}}))
			//////////////////////////////////////////////////////////////////////
			// Billable event on REST API endpoint
			// WARNING: Ingress / Egress bytess is taken care by the middleware
			//////////////////////////////////////////////////////////////////////
		...
		if err != nil {
			eosrest.WriteError(w, r, derr.HTTPNotFoundError(ctx, nil, derr.C("block_time_not_found"), "no results found for query"))
			//////////////////////////////////////////////////////////////////////
			// Billable event on REST API endpoint
			// WARNING: Ingress / Egress bytess is taken care by the middleware
			//////////////////////////////////////////////////////////////////////
		...
		eosrest.WriteJSON(w, r, map[string]interface{}{
