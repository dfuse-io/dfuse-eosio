...
func HealthzHandler(hub *hub.SubscriptionHub, api *eos.API, blocksStore dstore.Store, db eosrest.DB, fluxClient fluxdb.Client, searchEngine *eosrest.SearchEngine, expectedSecret string) http.Handler {
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
