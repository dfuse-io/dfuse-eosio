...
var CurrentConnections = Metricset.NewGauge("eosrest_current_connections", "Number of connections open on web socket")
...
var HeadBlockNum = Metricset.NewHeadBlockNumber("eosrest")
var HeadTimeDrift = Metricset.NewHeadTimeDrift("eosrest")
