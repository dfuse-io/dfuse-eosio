	...
	launcher.RegisterApp(&launcher.AppDef{
		...
		FactoryFunc: func(modules *launcher.RuntimeModules) (launcher.App, error) {
			...
			return fluxdbApp.New(&fluxdbApp.Config{
				...
				ReprocShardStartBlockNum: viper.GetUint64("fluxdb-reproc-shard-start-block-num"),
				ReprocShardStopBlockNum:  viper.GetUint64("fluxdb-reproc-shard-stop-block-num"),
