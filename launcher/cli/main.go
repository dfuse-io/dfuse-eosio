...
func Main() {
	...
	RootCmd.PersistentFlags().String("log-level-switcher-addr", "localhost:1065", "If non-empty, the process will listen on this address for json-formatted requests to change different logger levels (see DEBUG.md for more info)")
