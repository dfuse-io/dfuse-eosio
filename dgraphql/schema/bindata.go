...
func queryGraphql() (*asset, error) {
	...
	info := bindataFileInfo{name: "query.graphql", size: 3740, mode: os.FileMode(0644), modTime: time.Unix(1592200638, 0)}
...
func transactionsGraphql() (*asset, error) {
	...
	info := bindataFileInfo{name: "transactions.graphql", size: 15597, mode: os.FileMode(0644), modTime: time.Unix(1592200638, 0)}
