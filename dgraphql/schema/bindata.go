...
func accounthistGraphql() (*asset, error) {
	...
	info := bindataFileInfo{name: "accounthist.graphql", size: 3080, mode: os.FileMode(436), modTime: time.Unix(1598546956, 0)}
...
func queryGraphql() (*asset, error) {
	...
	info := bindataFileInfo{name: "query.graphql", size: 4671, mode: os.FileMode(436), modTime: time.Unix(1598558461, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
