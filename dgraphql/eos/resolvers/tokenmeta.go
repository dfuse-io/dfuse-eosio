...
func (r *Root) QueryTokens(ctx context.Context, args *TokensRequest) (*TokenConnection, error) {
	request := &pbtokenmeta.EOSGetTokensRequest{
		SortOrder: pbtokenmeta.SortOrder(pbtokenmeta.SortOrder_value[string(args.SortOrder)]),
		SortField: pbtokenmeta.EOSGetTokensRequest_SortField(pbtokenmeta.EOSGetTokensRequest_SortField_value[string(args.SortField)]),
	}
	...
	eosTokens := PagineableEOSTokens(resp.Tokens)
	...
	eosTokens = paginatedEosTokens.(PagineableEOSTokens)
...
func (r *Root) QueryAccountBalances(ctx context.Context, args *AccountBalancesRequest) (*AccountBalanceConnection, error) {
	...
	request := &pbtokenmeta.EOSGetAccountBalancesRequest{
		Account:   args.Account,
		Options:   []pbtokenmeta.EOSGetAccountBalancesRequest_Option{},
		SortOrder: pbtokenmeta.SortOrder(pbtokenmeta.SortOrder_value[string(args.SortOrder)]),
		SortField: pbtokenmeta.EOSGetAccountBalancesRequest_SortField(pbtokenmeta.EOSGetAccountBalancesRequest_SortField_value[string(args.SortField)]),
	}
	...
	if args.Options != nil {
		for _, option := range *args.Options {
			if o, ok := pbtokenmeta.EOSGetAccountBalancesRequest_Option_value[string(option)]; ok {
				request.Options = append(request.Options, pbtokenmeta.EOSGetAccountBalancesRequest_Option(o))
			}
		}
	}
...
func (r *Root) QueryTokenBalances(ctx context.Context, args *TokenBalancesRequest) (*AccountBalanceConnection, error) {
	request := &pbtokenmeta.EOSGetTokenBalancesRequest{
		TokenContract:      args.Contract,
		Options:            []pbtokenmeta.EOSGetTokenBalancesRequest_Option{},
		SortOrder:          pbtokenmeta.SortOrder(pbtokenmeta.SortOrder_value[string(args.SortOrder)]),
		SortField:          pbtokenmeta.EOSGetTokenBalancesRequest_SortField(pbtokenmeta.EOSGetTokenBalancesRequest_SortField_value[string(args.SortField)]),
	...
	if args.Options != nil {
		for _, option := range *args.Options {
			if o, ok := pbtokenmeta.EOSGetTokenBalancesRequest_Option_value[string(option)]; ok {
				request.Options = append(request.Options, pbtokenmeta.EOSGetTokenBalancesRequest_Option(o))
			}
		}
	}
...
//----------------------------
type Token struct {
	t *pbtokenmeta.EOSToken
}

func newToken(t *pbtokenmeta.EOSToken) *Token {
	return &Token{
		t: t,
	}
}
...
type AccountBalance struct {
	a *pbtokenmeta.EOSAccountBalance
}

func newAccountBalance(a *pbtokenmeta.EOSAccountBalance) *AccountBalance {
...
//----------------------------
type PagineableEOSTokens []*pbtokenmeta.EOSToken

func (e PagineableEOSTokens) IsEqual(index int, key string) bool {
...
func (e PagineableEOSTokens) Length() int {
	return len(e)
}

type PagineableAcccountBalances []*pbtokenmeta.EOSAccountBalance
