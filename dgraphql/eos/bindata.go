...
func blockGraphql() (*asset, error) {
	...
	info := bindataFileInfo{name: "block.graphql", size: 2923, mode: os.FileMode(420), modTime: time.Unix(1586802968, 0)}
...
func query_alphaGraphql() (*asset, error) {
	...
	info := bindataFileInfo{name: "query_alpha.graphql", size: 165, mode: os.FileMode(420), modTime: time.Unix(1586803180, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func transactionsGraphql() (*asset, error) {
	...
	info := bindataFileInfo{name: "transactions.graphql", size: 15597, mode: os.FileMode(420), modTime: time.Unix(1586802968, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
