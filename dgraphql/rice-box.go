...
func init() {
	...
	file2 := &embedded.EmbeddedFile{
		...
		FileModTime: time.Unix(1600711832, 0),
	...
	file3 := &embedded.EmbeddedFile{
		...
		FileModTime: time.Unix(1600718857, 0),
	...
	file4 := &embedded.EmbeddedFile{
		...
		FileModTime: time.Unix(1600718628, 0),
	...
	dir1 := &embedded.EmbeddedDir{
		Filename:   "",
		DirModTime: time.Unix(1600718857, 0),
