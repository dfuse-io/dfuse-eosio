...
var examplesBox = rice.MustFindBox("graphql-examples")

// GraphqlExamples is the ordered list of predefined GraphQL examples that should be
// displayed inside GraphiQL interface.
var GraphqlExamples = []*static.GraphqlExample{
	{
		Label:    "Search Stream (Forward)",
		Document: graphqlDocument("search_stream_forward.graphql"),
	...
	},
	{
		...
		Document: graphqlDocument("search_query_forward.graphql"),
		Variables: static.GraphqlVariablesByNetwork{
			"generic": r(`{"query": "receiver:eosio action:newaccount", "cursor": "", "limit": 10}`),
	...
	},
	{
		...
		Document: graphqlDocument("search_stream_backward.graphql"),
		Variables: static.GraphqlVariablesByNetwork{
	...
	},
	{
		...
		Document: graphqlDocument("search_query_backward.graphql"),
		Variables: static.GraphqlVariablesByNetwork{
	...
	{
		Label:    "Time Ranges",
		Document: graphqlDocument("time_ranges.graphql"),
		Variables: static.GraphqlVariablesByNetwork{
	...
	},
	{
		...
		Document: graphqlDocument("get_block_by_id.graphql"),
		Variables: static.GraphqlVariablesByNetwork{
	...
	},
	{
		...
		Document: graphqlDocument("get_block_by_num.graphql"),
		Variables: static.GraphqlVariablesByNetwork{
	...
	},
	{
		...
		Document:  graphqlDocument("get_tokens.graphql"),
		Variables: nil,
	},
	{
		Label:    "Get Token Balances (Alpha)",
		Document: graphqlDocument("get_token_balances.graphql"),
		Variables: static.GraphqlVariablesByNetwork{
	...
	},
	{
		...
		Document: graphqlDocument("get_account_balances.graphql"),
		Variables: static.GraphqlVariablesByNetwork{
...
func graphqlDocument(name string) static.GraphqlDocument {
	asset, err := examplesBox.String(name)
	if err != nil {
