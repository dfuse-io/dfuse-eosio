...
func init() {
	launcher.RegisterCommonFlags = func(cmd *cobra.Command) error {
		...
		cmd.Flags().String("common-blockmeta-addr", BlockmetaServingAddr, "[COMMON] gRPC endpoint to reach the Blockmeta. Used by: search-indexer, search-router, search-live, eosws, dgraphql, trxdb-loader (optional) , statedb (optional), mindreader (optional)")
